...
# Упрощённый встроенный GeoJSON для проверки работы (условные координаты и регионы)
uzb_geojson_data = {
  ...
  "features": [
    {
      ...
      "geometry": {
        "type": "Polygon",
        "coordinates": [[[66.0,39.0],[67.0,39.0],[67.0,40.0],[66.0,40.0],[66.0,39.0]]]
      }
    },
    {
      "type": "Feature",
      ...
      "geometry": {
        "type": "Polygon",
        "coordinates": [[[68.0,40.0],[69.0,40.0],[69.0,41.0],[68.0,41.0],[68.0,40.0]]]
      }
    }
  ]
}

# Генерация тестовых данных по регионам
def load_data():
...
m = folium.Map(location=[40.5, 67.0], zoom_start=6)
