...
def main_app():
    ...
    # Добавляем боковую панель для ввода данных
    ...
    # Данные коэффициентов для расчёта изменений свойств почвы
    biochar_data = {
        'Дерново-подзолистая почва': {
            'Скорлупа кедрового ореха': {
                600: {
                    'Теплопроводность, λ Вт/(м∙К)': {'a': 6.4030501558E-10, 'b': -3.9017669371E-07, 'c': -0.0002202355, 'd': 0},
                    'Удельное тепловое сопротивление, R (К∙м)/Вт': {'a': 5.5336168852E-07, 'b': -3.7725112350E-04, 'c': 0.0222171741, 'd': 0},
                    'Объемная теплоёмкость, Cv МДж/(м³∙К)': {'a': -1.2456373835E-07, 'b': 8.1649215602E-05, 'c': -0.0032040359, 'd': 0},
                    'Температуропроводность, а мм²/с': {'a': -1.4161903760E-08, 'b': 8.8998094542E-06, 'c': -0.0002875819, 'd': 0},
                },
            },
            'Помет': {
                400: {
                    'Теплопроводность, λ Вт/(м∙К)': {'a': -1.2003705484E-07, 'b': 8.0134814372E-05, 'c': -0.0036293444, 'd': 0},
                    'Удельное тепловое сопротивление, R (К∙м)/Вт': {'a': -7.1261584317E-07, 'b': 3.9517129660E-04, 'c': 0.0261195476, 'd': 0},
                    'Объемная теплоёмкость, Cv МДж/(м³∙К)': {'a': 2.1126725917E-07, 'b': -1.4845068697E-04, 'c': 0.0095133799, 'd': 0},
                    'Температуропроводность, а мм²/с': {'a': -3.5776620248E-09, 'b': 2.3431064427E-06, 'c': -0.0000685733, 'd': 0},
                },
            },
        },
    }
    ...
    # Используем вкладки для отображения свойств
